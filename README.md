...
[中文文档](README.zh.md) | [GitHub](https://github.com/ook826092-cloud/dsh-mobile-css)
...
Real-device captures of the adapted UI:

| | |
|---|---|
| ![Main view](assets/mobile-main.jpg) | ![Drawer sidebar](assets/mobile-drawer-sidebar.jpg) |
| ![Settings menu](assets/mobile-settings-menu.jpg) | ![Settings page](assets/mobile-settings-visual.jpg) |
